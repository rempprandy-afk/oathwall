...
export const metadata: Metadata = {
  title: "Terms of Use",
  description: "Terms of use for the oathwall open-source software and website.",
};
  ...
  return (
    <div className="wrap" style={{ maxWidth: 760, padding: "40px 24px 80px" }}>
      <article className="doc-body">
        ...
        <p>
          oathwall is free, open-source software published under the MIT License. This page explains
          the terms on which you use the software and this website (<strong>oathwall.dev</strong>).
        ...
        <p>
          oathwall is provided under the MIT License, without warranty of any kind — express or
        ...
        <p>
          oathwall is a tool for building and running automated trading strategies. It is{" "}
        ...
        <p>
          <strong>For on-chain trading</strong>, oathwall is self-hosted and non-custodial. It runs
          on your machine, generates and stores keys locally in
          your <code className="inline">~/.oathwall</code> directory, and interacts with public blockchains directly.
        ...
        <ul>
          <li>Securing the machine oathwall runs on and backing up your keys.</li>
        ...
        <p>
          ...
          &quot;monitor only&quot; behavior is a feature of oathwall&apos;s software, not a technical
          restriction on the token. Your brokerage login credentials are never seen or stored by
          oathwall — authorization happens on the brokerage&apos;s own pages — and you can revoke
          the connection at the brokerage at any time, independently of us.
        </p>

        <h2>4 · Third-party services</h2>
        <p>
          oathwall can connect to third-party services you configure — such as blockchain RPC and
        ...
        <p>
          Use oathwall lawfully. Do not use it to violate any law or regulation, to infringe others&apos;
        ...
        <div className="callout" style={{ marginTop: 40 }}>
          ...
          substitute for legal advice. If you operate oathwall commercially or at scale, consult a
          lawyer.
        </div>
      </article>
    </div>
