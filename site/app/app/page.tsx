 ...
 *
 * The art is generated (Higgsfield, dark-tech brief) and lives in
...
const ANDROID_DOWNLOAD = `${GITHUB}/releases/download/mobile-v${ANDROID_VERSION}/oathwall-demo-${ANDROID_VERSION}.apk`;

export const metadata: Metadata = {
  title: "Your agent, in your pocket — the oathwall app",
  description:
    "The oathwall mobile app: your agent's owner key is born on the phone, stored in the secure enclave, and never leaves. Sign the permission wall with your thumb. Android demo out now; iOS waiting list open.",
};

export default function AppPage() {
  return (
    <section className="apppage">
      {/* ── hero: the phone as the lantern ── */}
      ...
      <div className="wrap app-phone-section">
        <div className="app-phone-copy">
          <div className="tag" data-reveal="fade"><span className="n">01</span> your agent, at a glance</div>
          <h2 data-reveal="mask">One screen. The whole picture.</h2>
          <p data-reveal="up">
          ...
          <div className="app-phone" role="img" aria-label="The app's home screen: equity headline, sparkline, positions and recent decisions">
            ...
            <div className="app-screen">
              <div className="scr-row scr-top">
                <span className="scr-name">🛡 Atlas</span>
              ...
              <svg className="scr-spark" viewBox="0 0 300 64" preserveAspectRatio="none" aria-hidden="true">
                ...
                <path d="M0,46 L20,44 L40,47 L60,40 L80,42 L100,35 L120,38 L140,30 L160,33 L180,26 L200,29 L220,22 L240,25 L260,18 L280,21 L300,14" fill="none" stroke="var(--brass)" strokeWidth="2" strokeLinejoin="round" />
              </svg>
        ...
        <div className="app-truth-grid">
          ...
          <article className="app-truth" data-reveal="up">
            ...
            <p>
              ...
              <span className="mono-chip">the scout</span>, <span className="mono-chip">steady</span>,{" "}
              <span className="mono-chip">aggressive</span>.
            </p>
          </article>
        </div>
      </div>
      ...
      <div className="wrap app-honest" data-reveal="up">
        <div className="app-honest-card">
          ...
          <p className="app-honest-sub">
            The real-data build connects to a oathwall worker — your own self-hosted one, or the
      ...
      <div className="wrap app-get" id="ios">
        <div className="tag" data-reveal="fade"><span className="n">04</span> get started</div>
        ...
        <div className="app-get-grid">
          <div className="app-get-card" data-reveal="up">
            ...
            <p>
              Sideload the APK, meet your agent, walk the onboarding with a throwaway key. v
