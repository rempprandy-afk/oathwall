...
export function App() {
  ...
  const emptyMine = {name:"Your agent",slug:null,handle:null,owner:null,equity:null,chg24:null,mode:null,thesis:null,moves:[],activity:null,glance:{id:"custom" as const,label:"",cashUsd:undefined}};
